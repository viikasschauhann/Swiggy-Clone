...
export default function Card(props) {
  return (
    <div className='w-[240px] shrink-0 grow mb-3 '>
      <div className=' group h-[182px] rounded-[15px] overflow-hidden relative '>
        <img className=' group-hover:scale-110 duration-150 object-cover w-full h-full' src={"https://swiggy-api-vefd.onrender.com/images/" + props.image} alt="" />
      ...
      <div className='mt-3 font-bold text-xl'>{props.title}</div>
